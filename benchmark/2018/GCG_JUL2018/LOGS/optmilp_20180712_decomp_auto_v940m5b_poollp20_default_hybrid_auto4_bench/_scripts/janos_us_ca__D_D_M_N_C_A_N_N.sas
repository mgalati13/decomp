...
proc optmilp localdata=on nthreads=4 relobjgap=0.0001 data=lib.janos_us_ca__D_D_M_N_C_A_N_N &options; &optionsd hybrid=on; &optionsds; &optionsdm; &optionsdmip;
